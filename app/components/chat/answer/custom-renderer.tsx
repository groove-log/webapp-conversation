...
export const CustomRenderer: React.FC<CustomRendererProps> = ({ content, onSend }) => {
                    ...
                    <div className="p-4 flex-grow flex flex-col justify-between h-full">
                      <div>
                        <div className="flex items-start justify-between mb-2">
                          <h3 className="text-sm font-bold text-gray-900 leading-snug group-hover:text-gs-blue transition-colors line-clamp-2">{item.title}</h3>
                        </div>
                      ...
                      <div className="flex items-center justify-between mt-auto pt-2 border-t border-gray-50/50">
                        <span className="text-[11px] font-bold text-gs-blue uppercase tracking-tighter">{item.action?.label || '자세히 보기'}</span>
                        <div className="w-6 h-6 rounded-full bg-gs-blue/10 flex items-center justify-center text-gs-blue group-hover:bg-gs-blue group-hover:text-white transition-all">
        ...
        if (chunk.type === 'handoff') {
          return (
            <div key={idx} className="w-full pb-4 pt-2">
              <div className="bg-gradient-to-br from-gs-blue/10 to-gs-green/10 p-6 rounded-2xl border border-gs-blue/20 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-full bg-gs-blue flex items-center justify-center text-white shadow-md">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">GS리테일 상담사 연결</h3>
                    <p className="text-xs text-gs-blue font-medium uppercase tracking-wider">Professional Support</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  <button
                    className="flex items-center justify-between w-full p-4 bg-white hover:bg-gs-blue/5 border border-gray-100 hover:border-gs-blue/30 rounded-xl transition-all group"
                    onClick={() => {
                      openZendeskWidget('chat')
                    }}
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-gs-blue/10 flex items-center justify-center text-gs-blue">
                    ...
                    <svg className="text-gray-400 group-hover:text-gs-blue group-hover:translate-x-1 transition-all" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6" /></svg>
                  </button>

                  {/* 상담문의 하기 — Zendesk Contact Form */}
                  <button
                    className="flex items-center justify-between w-full p-4 bg-white hover:bg-gs-green/5 border border-gray-100 hover:border-gs-green/30 rounded-xl transition-all group"
                    onClick={() => {
                      openZendeskWidget('contact')
                    }}
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-gs-green/10 flex items-center justify-center text-gs-green">
